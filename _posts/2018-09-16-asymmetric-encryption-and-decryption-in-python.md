...
description: "In this post I will demonstrate the usage of the cryptography module by using using the symmetric key method RSA to encrypt and decrypt messages."
---

* content
{:toc}

In this post I will demonstrate the usage of the [cryptography](https://cryptography.io/en/latest/) module by using using the symmetric key method [RSA](https://en.wikipedia.org/wiki/RSA_(cryptosystem)) to encrypt and decrypt messages. I show how to generate keys, store the keys, read the keys and how to encrypt and decrypt messages and files. We will be using [cryptography.hazmat.primitives.asymmetric.rsa](https://cryptography.io/en/latest/hazmat/primitives/asymmetric/rsa/) to generate keys.
...
If you read my article on [Encryption and Decryption in Python]({{ site.baseurl }}{%- link _posts/2018-09-16-encryption-and-decryption-in-python.md -%}), you will see that I only used one key to encrypt and decrypt.
