...
![Save as .pyw](/post-assets/python-keylogger/pyw.png)
...
![shell:startup example](/post-assets/python-keylogger/run.png)
...
![Python in task manager](/post-assets/python-keylogger/taskmgr.png)
