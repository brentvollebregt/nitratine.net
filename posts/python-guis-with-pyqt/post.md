...
Your converted .py code should currently look something like this: *[Code download: MainWindowAdvanced1.py](/posts/python-guis-with-pyqt/MainWindowAdvanced1.py)*
