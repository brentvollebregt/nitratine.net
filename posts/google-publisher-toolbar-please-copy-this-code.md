...
![Google Publisher Toolbar Asking the User to Copy the Code](/post-assets/google-publisher-toolbar-please-copy-this-code/message.png)
...
![Loading the Google Publisher Toolbar URL into the CRXViewer](/post-assets/google-publisher-toolbar-please-copy-this-code/crxviewer.png)
...
![content_scripts in the manifest.json](/post-assets/google-publisher-toolbar-please-copy-this-code/content-scripts.png)
...
![Pasted JavaScript in Chome DevTools](/post-assets/google-publisher-toolbar-please-copy-this-code/pasted-js.png)
