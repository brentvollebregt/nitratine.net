...
const SideBar: React.FC<ISideBar> = ({ categories, recentVideos, featuredSites }) => (
  <aside className="col-blog-sidebar blog-sidebar">
    <div className="card p-3 mb-3 bg-light">
      ...
      <p className="mb-0">
        ...
        making quick tutorials for people new to particular topics in Python and tools that help fix
        small things.
      </p>
    </div>
