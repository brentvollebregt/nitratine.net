...
Just like downloading a web page, you can also download other files like images or videos. Simply find the URL of the image/other file _(make sure it is the URL of the file, not the URL of the page it's on)_ and use it like before; but this time put the content into a file.
