...
<div style="display: grid; grid-template-columns: repeat(3, 1fr); grid-gap: 3px;" class="mb-3">
    <div><img src="./nitratine3.jpg" alt="App home split light dark"/></div>
    <div><img src="./nitratine4.jpg" alt="App navigation"/></div>
    <div><img src="./nitratine5.jpg" alt="App article split light dark"/></div>
</div>
